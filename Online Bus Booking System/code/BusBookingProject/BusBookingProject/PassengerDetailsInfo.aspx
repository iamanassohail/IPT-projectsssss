                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="ddlBank" runat="server" class="form-control input-sm floatlabel">
                                ...
                                <asp:ListItem Value="1" Text="State Bank Of Pakistan"></asp:ListItem>
                                <asp:ListItem Value="2" Text="Bank Of Pakistan"></asp:ListItem>
                                <asp:ListItem Value="3" Text="HBL Bank"></asp:ListItem>
                                <asp:ListItem Value="4" Text="UBL Bank"></asp:ListItem>
                                <asp:ListItem Value="5" Text="Bank Of Punjab"></asp:ListItem>
                            </asp:DropDownList>
